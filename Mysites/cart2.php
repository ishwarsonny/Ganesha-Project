...
<body style="color:rgb(150, 150, 201)">
...
<td>2443</td>
<td>
<form method="get" action="cart5.php">
<input type="submit" style="height:30px;width:150px;background-color:red;color:white;margin-top:20px;font-size:20px" value="REMOVE">
</form>
...
<td><?= $price ?></td>
<td>
<form method="get" action="cart3.php">
<input type="submit" style="height:30px;width:150px;background-color:red;color:white;margin-top:20px;font-size:20px" value="REMOVE">
</form>
...
<form method="get" action="homepage.html">
<input type="submit" value="Back" style="height:50px;width:250px;background-color:Blue;margin-left:625px;margin-top:50;font-size:30px">
</form>
